...
"%":"HTMLAnchorElement"},oJ:{"":"BV;B:length=",
...
sR:function(a,b){this.hV(a,"width",b,"")}},Fk:{"":"a;Ph"},RO:{"":"qh;",
...
$isqC:true,
$isXj:true,
"%":";Uint8Array"},xG:{"":"AS+lD;",$isList:true,$asWO:null,$isqC:true},Vj:{"":"xG+SU;",$asWO:null}}],["","toggle.dart",,Y,{mo:function(a){J.oH(document.querySelector(".toggle-sidebar-left-arrow").style,"none")
J.oH(document.querySelector(".toggle-sidebar-right-arrow").style,"")
J.oH(document.querySelector(".right-helf").style,"")
J.vP(document.querySelector(".left-helf").style,"50%")},Ct:function(a){J.oH(document.querySelector(".toggle-sidebar-right-arrow").style,"none")
J.oH(document.querySelector(".toggle-sidebar-left-arrow").style,"")
J.oH(document.querySelector(".right-helf").style,"none")
J.vP(document.querySelector(".left-helf").style,"100%")},E2:function(){var z,y,x
z=document.querySelector(".toggle-sidebar-left-arrow")
J.oH(z.style,"none")
z.toString
y=C.T1.Ph
z=new W.Cq(z,y,!1)
H.VM(z,[null])
x=new W.xC(0,z.uv,z.Ph,W.VF(Y.Ti),z.Sg)
H.VM(x,[H.W8(z,"RO",0)])
x.Zz()
x=document.querySelector(".toggle-sidebar-right-arrow")
x.toString
y=new W.Cq(x,y,!1)
H.VM(y,[null])
x=new W.xC(0,y.uv,y.Ph,W.VF(Y.E5),y.Sg)
H.VM(x,[H.W8(y,"RO",0)])
x.Zz()}},1],])
...
init.globalFunctions.Ti=Y.Ti=new P.vE(Y.mo,"Ti")
init.globalFunctions.E5=Y.E5=new P.vE(Y.Ct,"E5")
